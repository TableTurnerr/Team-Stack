...
description: Creates clear documentation, API references, guides, and technical content. Use when writing READMEs, tutorials, or explaining complex technical concepts clearly.
---
